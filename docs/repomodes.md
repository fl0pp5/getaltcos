# Режимы работы с ACOS ostree репозиторием 
...
(http://ftp.altlinux.org/pub/distributions/ALTLinux/Sisyphus/, http://ftp.altlinux.org/pub/distributions/ALTLinux/p10/, ...). Это должно приводить к обновлению пакетов в репозиториях `ACOS ostree`.
...
Если администратором потоков принимается решение о более существенных изменениях в репозитории `ACOS ostree`, приводящее к существенному изменению состава пакетов и их разворачиванию, то формируется новая версия (commit) с новой версией даты: `sisyphus.20210911.0.0`, `sisyphus.20220112.0.0`, ...
...
и добавить изменения в новую минорную или мажорную версию `ACOS ostree` репозитория.
...
- за счет малого времени формирования нового репозитория позволит его применять для формирования пользовательских веток репозитория: `acos/x86_64/P10/Apache`, `acos/ppc64le/P10/ruby`, ...
